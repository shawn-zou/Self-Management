...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'user_email_status', 'user_phonenum', 'user_phone_status', 'is_status', 'user_sex', 'user_emotional_state', 'user_birthday', 'user_blood_type', 'user_qq', 'user_creatime', 'user_updatime', 'login_time', 'is_delete'], 'integer'],
            [['user_name', 'user_pwd', 'salt', 'user_pwd_hash', 'user_email', 'email_code', 'user_nickname', 'user_realname', 'user_location', 'user_introduction', 'user_img', 'login_ip', 'user_education_id', 'user_job_id', 'user_tag_id', 'user_shipping_address'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'user_creatime' => $this->user_creatime,
            'user_updatime' => $this->user_updatime,
